          ...
          ...Sales.map((e) => Card(
            color: Colors.blue.shade100,
                ...
                subtitle: Column(
                  ...
                  children: [Text("Invoice No. ${e["invoice"]}",
                        style: TextStyle(
                            fontSize:  SizeConfig.screenWidth * 0.042,
                            letterSpacing: 2,
                ...
                trailing: Column(children: [
                  Text("Rs.${e["amount"]}.00",
                    ...
                    (e["status"]=="Pending")?Container(
                      ...
                      width:  SizeConfig.screenWidth * 0.2,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(
                                    SizeConfig.screenWidth *0.042),color: Colors.green),
